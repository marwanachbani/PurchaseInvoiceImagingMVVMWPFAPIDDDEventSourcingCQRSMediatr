...
{
    public class IdentityAppContext :IdentityDbContext<UserApp>
    {
        ...
        private void SeedRoles(ModelBuilder builder)
        {
            builder.Entity<IdentityRole>().HasData(
                ...
                new IdentityRole() { Id = "c7b013f0-5201-4317-abd8-c211f91b7330", Name = "Client", ConcurrencyStamp = "2", NormalizedName = "Human Resource" }
                );
        }
